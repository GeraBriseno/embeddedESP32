        ...
        switch(variableSeleccionadaRecirculacion){
          case 0:
            ...
            if(estadoRecirculacion == 1){
              mandarDatosEthernet(11, presionResinaRecirculacion);
              }
            break;
          case 1:
            ...
            //mandarDatosEthernet(12, presionHardenerRecirculacion);
            if(estadoRecirculacion == 1){
              mandarDatosEthernet(13, presionHardenerRecirculacion);
              }
            break;
          case 2:
          ...
          switch(variableSeleccionadaInyeccion){
            case 0:
              ...
              if(estadoInyeccion == 1 && estadoPausaInyeccion == 0){
                mandarDatosEthernet(15, presionResinaInyeccion);
              }
              break;
            case 1:
              ...
              //mandarDatosEthernet(16, presionHardenerInyeccion);
              if(estadoInyeccion == 1 && estadoPausaInyeccion == 0){
                mandarDatosEthernet(17, presionHardenerInyeccion);
              }
              break;
            case 2:
              ...
              if(estadoInyeccion == 1){
                mandarDatosEthernet(19, presionAireInyeccion);
              }
              break;
            }
            break;
            ...
            switch(variableSeleccionadaPurgas){
              case 0:
                ...
                if(estadoPurga == 1 && purgaSeleccionada == 1){
                  mandarDatosEthernet(21, presionResinaPurgas);
                }
                break;
              case 1:
                ...
                if(estadoPurga == 1 && purgaSeleccionada == 2){
                  mandarDatosEthernet(23, presionHardenerPurgas);
                }
                break;
          }
        break;
